    ...
    public ResponseEntity<Resource> generaReporte(String reporte, Map<String, Object> parametros, String tipo) throws IOException {
        try {
            ...
            if ("vPdf".equals(tipo)) { //eye (archivo)
                ...
                estilo = "attachment; "; //se va a descargar el archivo
            }
            ...
            ClassPathResource fuente
                    = new ClassPathResource( //fuente -> (reportes), reporte=usuarios.jasper
                            reportePath
                            + File.separator
                            + reporte
                            + ".jasper");
            ...
            var reporteJasper //informacion dentro de usuarios.jasper
                    = JasperFillManager
                            .fillReport(
                                    elReporte,
                                    parametros,
